...
### Linear Regression of CINC as a predication of War Potential
```{python}
import pandas as pd  
import numpy as np  
...
While though the variable make sense logically, when it is plotted against CINC it starts to lose meaning. It therefore is not a good indicator, alone, for predicting US war potential. Therefore, other options should first be explored before jumping to this variable alone as a good measure of state power.
